...
// 클라이언트를 실행하면 콘솔에서 [상품 목록]과 메뉴가 출시됩니다.
...
public class MissionProductClient {
    //필드
    ...
    public void update() throws IOException {
        ...
        JSONObject response = new JSONObject(dis.readUTF()); if(response.getString("status").equals("success")) {
            list();
        }
    }
    ...
    public static void main(String[] args) {
        MissionProductClient productClient = new MissionProductClient();
        try {
            productClient.start();
        } catch(IOException e) {
